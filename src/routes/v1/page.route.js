...
router.route('/').post(auth(), validate(pageValidation.createPage), pageController.createPage);

router.route('/user/:userId').get(auth(), validate(pageValidation.getPagesByUserId), pageController.getPagesByUserId);

router
  .route('/id/:pageId')
  .get(auth(), validate(pageValidation.getPage), pageController.getPage)
...
router.route('/page/:pageName').get(auth(), validate(pageValidation.getPageByName), pageController.getPageByName);
